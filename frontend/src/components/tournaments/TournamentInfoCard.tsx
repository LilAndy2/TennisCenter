...
function TournamentInfoCard({ tournament, actions }: TournamentInfoCardProps) {
    return (
        <HeroCard>
            <TopBadgesRow>
                <LeftBadges>
            ...
            <InfoGrid>
                ...
                <InfoItem>
                    ...
                    <InfoTextBlock>
                        ...
                        <InfoValue>
                            {tournament.locationNames?.join(", ") || "No locations assigned"}
                        </InfoValue>
                    </InfoTextBlock>
                </InfoItem>
...
const StatusBadge = styled(Typography)<{ $status: string }>`
  ...
  background: ${({ $status }) => {
    switch ($status) {
        ...
        case "Ongoing":  return "#ecfdf5";
        case "Finished": return "#f1f5f9";
