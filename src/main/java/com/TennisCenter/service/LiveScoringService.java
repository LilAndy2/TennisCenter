...
import com.TennisCenter.service.match.TennisScoreEngine;
...
public class LiveScoringService {
    ...
    private LiveScoreResponse buildLiveScoreResponse(TournamentMatch match,
        ...
        return LiveScoreResponse.builder()
                .matchId(match.getId())
                .playerOneName(match.getPlayerOne().getFirstName() + " " + match.getPlayerOne().getLastName())
                .playerTwoName(match.getPlayerTwo().getFirstName() + " " + match.getPlayerTwo().getLastName())
